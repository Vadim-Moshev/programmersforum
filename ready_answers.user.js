		  	...
		  	// Список названий готовых ответов
		  		...
		  		// Массив объектов с названиями и значениями ответов (Здесь \n и <br> не работают)
		  			let answersTextsAndValues = [
		  				...
		  				{
		  					name: 'Начните решать самостоятельно',
		  					value: 'Начните решать задачу самостоятельно. Если что-то не будет получаться, показывайте то, '
		  					       + 'что сделали, задавайте конкретные вопросы.'
		  				},
		  				{
